...
(function () {
    ...
    function Xa(h, m, B) {
        ...
        if (isNaN(w)) {
            try {
                ...
                wa.style.display = "";
                W(wa, { position: "absolute", left: "0px", top: "-20000px", padding: "0px", margin: "0px", border: "none", whiteSpace: "pre", lineHeight: "normal", fontFamily: h, fontSize: m + "px", fontWeight: B });
    ...
    function hb(h) {
        if (h._menuButton) h.exportEnabled ? (W(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), La(h._menuButton), (h._menuButton.title = h._cultureInfo.menuText)) : ua(h._menuButton);
            ...
            K(
                ...
                function () {
                    m ||
                        (W(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }),
                        0 >= navigator.userAgent.search("MSIE") && W(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                },
                h.allDOMEventHandlers,
                !0
            );
            K(
                ...
                function () {
                    m ||
                        (W(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }),
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            for (var B = h._dropdownMenu.childNodes, r = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], ta = 0; ta < B.length; ta++)
                W(B[ta], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), (B[ta].innerHTML = r[ta]);
        } else
            !h._dropdownMenu &&
                h.exportEnabled &&
                w &&
    ...
    function va(h, m, B) {
        m.getAttribute("state") ||
            ((m.style.backgroundColor = h.toolbar.itemBackgroundColor), (m.style.color = h.toolbar.fontColor), (m.style.border = "none"), W(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        m.getAttribute("state") !== B &&
            (m.setAttribute("state", B),
            m.setAttribute("type", "button"),
            W(m, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
            m.setAttribute("title", h._cultureInfo[B + "Text"]),
            (m.innerHTML = "<img src='" + kb[B].image + "' alt='" + h._cultureInfo[B + "Text"] + "' />"),
    ...
    function ya(h, m) {
        ...
        if (r(this.options.margin) && h.options.subtitles)
            for (var B = h.options.subtitles, w = 0; w < B.length; w++)
                if (
                    ((r(B[w].horizontalAlign) && "center" === this.horizontalAlign) || B[w].horizontalAlign === this.horizontalAlign) &&
                    ((r(B[w].verticalAlign) && "top" === this.verticalAlign) || B[w].verticalAlign === this.verticalAlign) &&
    ...
    var $ = 20,
        ...
        Va = {
            ...
            subtitles: [{ fontFamily: Fa, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            data: [{ indexLabelFontFamily: v, indexLabelFontSize: E, indexLabelFontColor: ca, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
            axisX: [
                {
                    titleFontFamily: v,
                    titleFontSize: $,
                    ...
                    crosshair: { labelFontFamily: v, labelFontSize: E, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: Y, color: ha, thickness: 1, lineDashType: "dash" },
    ...
    Fa = {
        ...
        data: [{ indexLabelFontFamily: v, indexLabelFontSize: E, indexLabelFontColor: X, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [
            {
                titleFontFamily: v,
                titleFontSize: $,
                ...
                gridColor: R,
                stripLines: [{ labelFontFamily: v, labelFontSize: E, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
                crosshair: { labelFontFamily: v, labelFontSize: E, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: Y, color: ha, thickness: 1, lineDashType: "dash" },
        ...
        legend: { fontFamily: v, fontSize: 14, fontColor: ca, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
        toolTip: { fontFamily: v, fontSize: 14, fontStyle: "normal", cornerRadius: 0, borderThickness: 1, fontColor: X, backgroundColor: "rgba(0, 0, 0, .7)" },
    };
    R = "#FFFFFF";
    X = ca = "#FAFAFA";
    ha = "#40BAF1";
    ...
    var $ = 20,
        ...
        bb = {
            ...
            dark2: {
                ...
                subtitles: [{ fontFamily: v, fontSize: E, fontColor: ca, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
                toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" },
                data: [{ indexLabelFontFamily: v, indexLabelFontSize: E, indexLabelFontColor: X, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
                axisX: [
                    {
                ...
                if (((m = O.pop()), "#" === m || "0" === m))
                    ...
                    ("E" !== m[0] && "e" !== m[0]) || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m)
                        ? "," === m
                            ...
                            : (r = 1 < m.length && (('"' === m[0] && '"' === m[m.length - 1]) || ("'" === m[0] && "'" === m[m.length - 1])) ? m.slice(1, m.length - 1) + r : m + r)
                        : ((m = 0 > W ? m.replace("+", "").replace("-", "") : m.replace("-", "")),
    ...
    V.prototype.updateOption = function (h) {
        ...
        this.theme && r(this.parent) && r(E) && r(S)
            ...
            : this.parent &&
              ...
              (null === S ? (w = this.parent.themeOptions[E]) : 0 < this.parent.themeOptions[E].length && ((w = Math.min(this.parent.themeOptions[E].length - 1, S)), (w = this.parent.themeOptions[E][w])));
        this.themeOptions = w;
    ...
    V.prototype.dispatchEvent = function (h, m, r) {
        if (h && this._eventListeners[h]) {
            m = m || {};
            for (var w = this._eventListeners[h], v = 0; v < w.length; v++) w[v].eventHandler.call(w[v].context, m);
        }
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? (null === this.maxWidth && (this.maxWidth = m.width - 4 - A * ("center" === this.horizontalAlign ? 2 : 1)), (J = 0.5 * m.height - this.margin - 2), (E = 0))
            ...
            O = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((v = m.y1 + 2), (K = "top")) : "bottom" === this.verticalAlign && ((v = m.y2 - 2 - O.height), (K = "bottom")),
                  "left" === this.horizontalAlign ? (w = m.x1 + 2) : "center" === this.horizontalAlign ? (w = m.x1 + m.width / 2 - O.width / 2) : "right" === this.horizontalAlign && (w = m.x2 - 2 - O.width - A),
                  (I = this.horizontalAlign),
                  (this.width = O.width),
                  (this.height = O.height))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((w = m.x1 + 2), (v = m.y2 - 2 - (this.maxWidth / 2 - O.width / 2)), (E = -90), (K = "left"), (this.width = O.height), (this.height = O.width))
                      : "right" === this.horizontalAlign
                      ? ((w = m.x2 - 2), (v = m.y1 + 2 + (this.maxWidth / 2 - O.width / 2)), (E = 90), (K = "right"), (this.width = O.height), (this.height = O.width))
                      : "center" === this.horizontalAlign && ((v = h.y1 + (h.height / 2 - O.height / 2)), (w = h.x1 + (h.width / 2 - O.width / 2)), (K = "center"), (this.width = O.width), (this.height = O.height)),
                  (I = "center"));
            J.x = w;
            J.y = v;
            J.angle = E;
    ...
    v = Pa.Chart = (function () {
            ...
            (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId)
                ? ((this.container.innerHTML = ""),
                  ...
                  this.canvas.getContext &&
                      ...
                      W(this._toolBar, { position: "absolute", right: "1px", top: "1px" }),
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    var D = (a[l].x - a[f].x) / b;
                    b = (a[l].y - a[f].y) / b;
                    c[c.length] = (a[s].x > a[f].x && 0 < D) || (a[s].x < a[f].x && 0 > D) ? { x: a[s].x + D / 3, y: a[s].y + b / 3 } : { x: a[s].x, y: a[s].y + b / 9 };
                    s = e;
                    f = 0 === s ? 0 : s - 1;
                    l = s === a.length - 1 ? s : s + 1;
        ...
        function X(a, d, c, b) {
            ...
            if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
                for (a = 0; a < this.options.customBreaks.length; a++)
                    this.customBreaks.push(new $(this.chart, "customBreaks", this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)),
        ...
        m.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton)
                    W(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
                    ...
                    K(
                        ...
                        function () {
                            d
                                ? (d = !1)
                                : (W(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                    ...
                    K(
                        ...
                        function () {
                            d ||
                                (W(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                0 >= navigator.userAgent.search("MSIE") && W(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                        },
                        this.allDOMEventHandlers
                    );
                }
                this._resetButton
                    ? (W(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
                    ...
                    : ((d = !1),
                      ...
                      K(
                          ...
                          function () {
                              d ||
                                  (W(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                      ...
                      K(
                          ...
                          function () {
                              d ||
                                  (W(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                  0 >= navigator.userAgent.search("MSIE") && W(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                          },
                          this.allDOMEventHandlers
                      ),
                            ...
                            for (var e = 0; e < c.length; e++)
                                (D = c[e]),
                                    1 > a && "undefined" !== typeof D.startTimePercent
                                        ? a >= D.startTimePercent && D.animationCallback(D.easingFunction(a - D.startTimePercent, 0, 1, 1 - D.startTimePercent), D)
                    ...
                    for (D = 0; D < s.dataPoints.length; D++) {
                        ...
                        if (0 < D) {
                            ...
                            null !== e &&
                                ...
                                (a.axisY.logarithmic
                                    ? ((t = e / s.dataPoints[D - 1].y), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
                                    : ((t = e - s.dataPoints[D - 1].y), 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t)));
                        }
                        if (b < q && !k) null !== e && (p = b);
                        else {
                            if (!k && ((k = !0), 0 < D)) {
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                        ...
                        if (b < fa && !g) null !== p.dataPoints[q].y && (h = b);
                            ...
                            null === p.dataPoints[q].y
                                ...
                                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                                  ...
                                  0 <= e ? (l[b] ? (l[b] += e) : ((l[b] = e), (D = Math.min(e, D)))) : s[b] ? (s[b] += e) : ((s[b] = e), (k = Math.max(e, k))));
                        }
                    }
                    a.axisY.scaleBreaks &&
                ...
                for (q in l)
                    l.hasOwnProperty(q) &&
                        ...
                        a > d.max && (d.max = a),
                        q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, D)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in s)
                    s.hasOwnProperty(q) &&
                        !isNaN(q) &&
                        ((a = s[q]),
        ...
        m.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                ...
                a.axisY.logarithmic
                    ...
                    : !l && s && ((d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = D;
            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, s = !1, D = 0; D < a.dataSeriesIndexes.length; D++) {
                    ...
                    for (n = 0; n < k.dataPoints.length; n++) {
                        ...
                        0 < n &&
                            (a.axisX.logarithmic
                                ? ((t = b / k.dataPoints[n - 1].x), 1 > t && (t = 1 / t), c.minDiff > t && 1 !== t && (c.minDiff = t))
                                : ((t = b - k.dataPoints[n - 1].x), 0 > t && (t *= -1), c.minDiff > t && 0 !== t && (c.minDiff = t)),
                            e &&
                                null !== e[0] &&
                                k.dataPoints[n - 1].y &&
                                null !== k.dataPoints[n - 1].y[0] &&
                                (a.axisY.logarithmic
                                    ? ((t = e[0] / k.dataPoints[n - 1].y[0]), 1 > t && (t = 1 / t), d.minDiff > t && 1 !== t && (d.minDiff = t))
                                    : ((t = e[0] - k.dataPoints[n - 1].y[0]), 0 > t && (t *= -1), d.minDiff > t && 0 !== t && (d.minDiff = t))));
                        if (!(b < m) || p) {
                            if (!p && ((p = !0), 0 < n)) {
                                n -= 2;
                                g = h;
        ...
        m.prototype._processSpecificPlotUnit = function (a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if ((s.dataPoints[D].x && s.dataPoints[D].x.getTime) || "dateTime" === s.xValueType) f = !0;
                    for (D = 0; D < s.dataPoints.length; D++)
                        "undefined" !== typeof s.dataPoints[D].isCumulativeSum && !0 === s.dataPoints[D].isCumulativeSum
                            ? ((s.dataPointEOs[D].cumulativeSumYStartValue = 0), (s.dataPointEOs[D].cumulativeSum = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum), (s.dataPoints[D].y = 0 === D ? 0 : s.dataPointEOs[D - 1].cumulativeSum))
                            : "undefined" !== typeof s.dataPoints[D].isIntermediateSum && !0 === s.dataPoints[D].isIntermediateSum
                            ? ((s.dataPointEOs[D].cumulativeSumYStartValue = p),
                              ...
                              (b = 0))
                            : ((e = "number" !== typeof s.dataPoints[D].y ? 0 : s.dataPoints[D].y),
                    ...
                    for (D = 0; D < s.dataPoints.length; D++)
                        if (
                            ...
                            0 < D &&
                                (a.axisX.logarithmic
                                    ? ((p = b / s.dataPoints[D - 1].x), 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p))
                                    : ((p = b - s.dataPoints[D - 1].x), 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)),
                                null !== e &&
                                    null !== s.dataPoints[D - 1].y &&
                                    (a.axisY.logarithmic
                                        ? ((e = s.dataPointEOs[D].cumulativeSum / s.dataPointEOs[D - 1].cumulativeSum), 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e))
                                        : ((e = s.dataPointEOs[D].cumulativeSum - s.dataPointEOs[D - 1].cumulativeSum), 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))),
                            !(b < q) || k)
                        ) {
                            if (!k && ((k = !0), 0 < D)) {
                                D -= 2;
                            ...
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < D &&
                                (s.dataPointEOs[D - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = s.dataPointEOs[D - 1].cumulativeSum),
        ...
        m.prototype.calculateAutoBreaks = function () {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, l = f.min, k = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, s = 0, D = 0; D < a.dataSeriesIndexes.length; D++) {
                            var h = e.data[a.dataSeriesIndexes[D]];
                            if (!(4 > h.dataPoints.length))
                                for (s = 0; s < h.dataPoints.length; s++)
                                    if (
                                        (b &&
                                            ((q = ((k + 1 - l) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                    ...
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        for (s = 0; s < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); s++)
                            (b = a(f[s].start, f[s].end, this._axes[l].logarithmic ? this._axes[l].dataInfo.max / this._axes[l].dataInfo.min : this._axes[l].dataInfo.max - this._axes[l].dataInfo.min, this._axes[l].logarithmic)),
                                this._axes[l].scaleBreaks.autoBreaks.push(new $(this, "autoBreaks", b, s, ++this._eventManager.lastObjectId, this._axes[l].scaleBreaks)),
        ...
        m.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== G && "" !== G) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== x
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < v
                                  ? ((g = n.point.y + ("horizontal" === z ? t / 2 : 0) - k - s - b), g < e && ((g = "auto" === x ? Math.max(n.point.y, e) + t / 2 + s : e + t / 2 + s), (A = g + k > n.point.y)))
                                  : ((g = n.point.y + t / 2 + s + b), g > f - k && ((g = "auto" === x ? Math.min(n.point.y, f) + t / 2 - k - s : f + t / 2 - k), (A = g < n.point.y))))
                            : ((e = Math.max(n.bounds.y1, c.y1)),
                              ...
                              (b =
                                  0 <= p.indexOf("range") || "error" === p
                                      ...
                                      : (Math.max(n.bounds.y1, c.y1) + Math.min(n.bounds.y2, c.y2)) / 2 - k / 2 + t / 2 + ("horizontal" === z ? s : 0)),
                              0 < v
                                  ? ((g = Math.max(n.point.y, b)), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(n.point.y - k - s, c.y1 + s)))
                                  : ((g = Math.min(n.point.y, b)), g > f - k - s && ("bubble" === p || "scatter" === p) && (g = Math.min(n.point.y + s, c.y2 - k - s))),
                              (g = Math.min(g, f)));
                    } else
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((x = "auto"), (l = 4)) : 0 <= p.indexOf("stacked") ? "auto" === x && (x = "inside") : "bubble" === p && (x = "inside"),
                            ...
                            "inside" !== x
                                ? ((e = c.x1),
                                  (f = c.x2),
                                  0 > v
                                      ? ((q = n.point.x - ("horizontal" === z ? D : D - t / 2) - l - b), q < e && ((q = "auto" === x ? Math.max(n.point.x, e) + l : e + l), (A = q + D > n.point.x)))
                                      : ((q = n.point.x + ("horizontal" === z ? 0 : t / 2) + l + b),
                                        q > f - D - l - b && ((q = "auto" === x ? Math.min(n.point.x, f) - ("horizontal" === z ? D : D / 2) - l : f - D - l), (A = q < n.point.x))))
                                  ...
                                  (b =
                                      0 <= p.indexOf("range") || "error" === p
                                          ? 0 > v
                                              ...
                                              : Math.min(n.bounds.x2, c.x2) - D / 2 - l + ("horizontal" === z ? 0 : t / 2)
                                          : (Math.max(n.bounds.x1, c.x1) + Math.min(n.bounds.x2, c.x2)) / 2 + ("horizontal" === z ? 0 : t / 2)),
                                  (q = 0 > v ? Math.max(n.point.x, b) - ("horizontal" === z ? D / 2 : 0) : Math.min(n.point.x, b) - D / 2),
                                  (q = Math.max(q, e)));
                    "vertical" === z && (g += k - t / 2);
                    h.x = q;
                    h.y = g;
                    ...
                    y &&
                        "inside" !== x &&
                        ((0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2) || !A) &&
                        ((0 > p.indexOf("column") && ("error" !== p || n.axisSwapped) && n.point.y > c.y1 && n.point.y < c.y2) || !A) &&
                        ((d.lineWidth = y),
                        ...
                        0 <= p.indexOf("bar") || ("error" === p && n.axisSwapped)
                            ? d.lineTo(q + (0 < n.direction ? -l : D + l) + ("vertical" === z ? -t / 2 : 0), g + ("vertical" === z ? -k / 2 : k / 2 - t / 2) - s)
                            : 0 <= p.indexOf("column") || ("error" === p && !n.axisSwapped)
                            ? d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : t / 2), g + ("vertical" === z ? (g - k < n.point.y ? 0 : -k) + s : (g - t / 2 < n.point.y ? k : 0) - t / 2))
                            : d.lineTo(q + D / 2 - ("horizontal" === z ? 0 : t / 2), g + ("vertical" === z ? (g - k < n.point.y ? 0 : -k) : (g - t / 2 < n.point.y ? k : 0) - t / 2)),
                        d.stroke());
                }
            }
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < n.length) {
                        for (var z = !1, u = 0; u < n.length; u++)
                            if (((r = n[u].x.getTime ? n[u].x.getTime() : n[u].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))))
                                if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || z || m) && (c.stroke(), w && b.stroke()), (z = !0);
                                else {
                                    ...
                                    m || z
                                        ? (!m && k.connectNullData
                                              ? (c.setLineDash &&
                                                ...
                                                c.lineTo(r, x),
                                                w && b.lineTo(r, x))
                                              : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(), b.moveTo(r, x))),
                                          (z = m = !1))
                                        : (c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                                    l = { x: r, y: x };
                                    u < n.length - 1 &&
                                        ...
                                        (h = n[u].lineColor || t),
                                        (c.strokeStyle = h),
                                        c.setLineDash && (n[u].lineDashType ? ((p = n[u].lineDashType), c.setLineDash(J(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    ...
                                    (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "line", dataPoint: n[u], dataSeries: k, point: { x: r, y: x }, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: t });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
        ...
        m.prototype.renderStepLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < n.length) {
                        for (var z = !1, u = 0; u < n.length; u++)
                            if (((r = n[u].getTime ? n[u].x.getTime() : n[u].x), !(r < a.axisX.dataInfo.viewPortMin || (r > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !z)))))
                                if ("number" !== typeof n[u].y) 0 < u && !(k.connectNullData || z || m) && (c.stroke(), w && b.stroke()), (z = !0);
                                else {
                                    var G = x;
                                    r = a.axisX.convertValueToPixel(r);
                                    ...
                                    m || z
                                        ? (!m && k.connectNullData
                                              ...
                                              : (c.beginPath(), c.moveTo(r, x), w && (b.beginPath(), b.moveTo(r, x))),
                                          (z = m = !1))
                                        : (c.lineTo(r, G), w && b.lineTo(r, G), c.lineTo(r, x), w && b.lineTo(r, x), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(r, x), w && (b.stroke(), b.beginPath(), b.moveTo(r, x))));
                                    l = { x: r, y: x };
                                    u < n.length - 1 &&
                                        (h !== (n[u].lineColor || t) || p !== (n[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(),
                                        ...
                                        c.setLineDash && (n[u].lineDashType ? ((p = n[u].lineDashType), c.setLineDash(J(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    if (0 < n[u].markerSize || 0 < k.markerSize)
                                        (G = k.getMarkerProperties(u, r, x, c)), f.push(G), (C = P(C)), w && f.push({ x: r, y: x, ctx: b, type: G.type, size: G.size, color: C, borderColor: C, borderThickness: G.borderThickness });
                                    (n[u].indexLabel || k.indexLabel || n[u].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stepLine", dataPoint: n[u], dataSeries: k, point: { x: r, y: x }, direction: 0 > n[u].y === a.axisY.reversed ? 1 : -1, color: t });
                                }
                        c.stroke();
                        w && b.stroke();
                    }
                            ...
                            if (((u = n[r].getTime ? n[r].x.getTime() : n[r].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !m)))))
                                if ("number" !== typeof n[r].y)
                                    0 < r &&
                                        !m &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < x.length && (k.options.nullDataLineDashType || !n[r - 1].lineDashType) && ((x[x.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType))
                                            : (d(x), (x = []))),
                                        (m = !0);
                                else {
                                    ...
                                    r < n.length - 1 &&
                                        ...
                                        b.setLineDash && (n[r].lineDashType ? ((p = n[r].lineDashType), (x[x.length - 1].newLineDashArray = J(p, k.lineThickness))) : ((p = k.lineDashType), (x[x.length - 1].newLineDashArray = g))));
                                    if (0 < n[r].markerSize || 0 < k.markerSize) {
                                        var G = k.getMarkerProperties(r, u, m, b);
                                        l.push(G);
                                        z = P(z);
                                        w && l.push({ x: u, y: m, ctx: e, type: G.type, size: G.size, color: z, borderColor: z, borderThickness: G.borderThickness });
                                    }
                                    (n[r].indexLabel || k.indexLabel || n[r].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: n[r], dataSeries: k, point: { x: u, y: m }, direction: 0 > n[r].y === a.axisY.reversed ? 1 : -1, color: t });
                                    m = !1;
                                }
                    d(x);
                }
                    ...
                    if (0 < t.length)
                        for (var h = 5 < p && g.bevelEnabled ? !0 : !1, f = 0; f < t.length; f++)
                            if ((t[f].getTime ? (D = t[f].x.getTime()) : (D = t[f].x), !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y)) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: s, x2: r, y2: u };
                                b = P(b);
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                                    (s[b] = u[k].y + (s[b] ? s[b] : 0)), 0 < s[b] && ((p = a.axisY.convertValueToPixel(s[b])), (z = "undefined" !== typeof f[b] ? f[b] : q), (f[b] = p));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y)
                                    (D[b] = u[k].y + (D[b] ? D[b] : 0)), (z = a.axisY.convertValueToPixel(D[b])), (p = "undefined" !== typeof l[b] ? l[b] : q), (l[b] = z);
                                ...
                                (u[k].indexLabel || r.indexLabel || u[k].indexLabelFormatter || r.indexLabelFormatter) &&
                                    this._indexLabels.push({
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var h = a.dataSeriesIndexes[g],
                        ...
                        u = r.dataPoints;
                    if (0 < u.length)
                        for (var m = 5 < t && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                n = a.axisX.convertValueToPixel(b);
                    ...
                    if (0 < t.length) {
                        ...
                        for (f = 0; f < t.length; f++)
                            if ((t[f].getTime ? (D = t[f].x.getTime()) : (D = t[f].x), !(D < a.axisX.dataInfo.viewPortMin || D > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[f].y)) {
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: u, y1: s, x2: l, y2: r };
                                b = P(b);
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                var x = (p + t) << 0,
                                    z;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                                    (s[b] = u[k].y + (s[b] ? s[b] : 0)), 0 < s[b] && ((z = f[b] ? f[b] : q), (f[b] = n = a.axisY.convertValueToPixel(s[b])));
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < t.length) {
                        ...
                        for (var ka = !0; h < t.length; h++)
                            if (((m = t[h].x.getTime ? t[h].x.getTime() : t[h].x), !(m < a.axisX.dataInfo.viewPortMin || (m > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ka)))))
                                if ("number" !== typeof t[h].y) g.connectNullData || ka || d || b(), (ka = !0);
                                else {
                                    ...
                                    d || ka
                                        ? (!d && g.connectNullData
                                              ? (f.setLineDash &&
                                                    ...
                                                    ((d = r), (c = u), (r = n.x), (u = n.y), b(), f.moveTo(n.x, n.y), (r = d), (u = c), (G = n), (c = g.nullDataLineDashType), f.setLineDash(M)),
                                                f.lineTo(r, u),
                                                w && l.lineTo(r, u))
                                              : (f.beginPath(), f.moveTo(r, u), w && (l.beginPath(), l.moveTo(r, u)), (G = { x: r, y: u })),
                                          (ka = d = !1))
                                        : (f.lineTo(r, u), w && l.lineTo(r, u), 0 == h % 250 && b());
                                    n = { x: r, y: u };
                                    h < t.length - 1 &&
                                        ...
                                        (A = t[h].lineColor || v),
                                        (f.strokeStyle = A),
                                        f.setLineDash && (t[h].lineDashType ? ((c = t[h].lineDashType), f.setLineDash(J(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(T))));
                                    var aa = g.dataPointIds[h];
                                    this._eventManager.objectMap[aa] = { id: aa, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: r, y1: u };
                                    0 !== t[h].markerSize &&
                                        (0 < t[h].markerSize || 0 < g.markerSize) &&
                                        ((m = g.getMarkerProperties(h, r, u, f)), D.push(m), (aa = P(aa)), w && D.push({ x: r, y: u, ctx: l, type: m.type, size: m.size, color: aa, borderColor: aa, borderThickness: m.borderThickness }));
                                    (t[h].indexLabel || g.indexLabel || t[h].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: t[h], dataSeries: g, point: { x: r, y: u }, direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1, color: C });
                                }
                        b();
                        ba.drawMarkers(D);
                    }
                            ...
                            if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !t)))))
                                if ("number" !== typeof p[q].y)
                                    0 < q &&
                                        !t &&
                                        (n.connectNullData
                                            ? b.setLineDash && 0 < y.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((y[y.length - 1].newLineDashArray = A), (C = n.nullDataLineDashType))
                                            : (d(), (y = []))),
                                        (t = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[M] = { id: M, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: q, x1: g, y1: t };
                                    y[y.length] = { x: g, y: t };
                                    q < p.length - 1 &&
                                        (G !== (p[q].lineColor || z) || C !== (p[q].lineDashType || n.lineDashType)) &&
                                        ((G = p[q].lineColor || z),
                                        (y[y.length - 1].newStrokeStyle = G),
                                        b.setLineDash && (p[q].lineDashType ? ((C = p[q].lineDashType), (y[y.length - 1].newLineDashArray = J(C, n.lineThickness))) : ((C = n.lineDashType), (y[y.length - 1].newLineDashArray = E))));
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < n.markerSize)) {
                                        var T = n.getMarkerProperties(q, g, t, b);
                                        l.push(T);
                                        M = P(M);
                                        w && l.push({ x: g, y: t, ctx: e, type: T.type, size: T.size, color: M, borderColor: M, borderThickness: T.borderThickness });
                                    }
                                    (p[q].indexLabel || n.indexLabel || p[q].indexLabelFormatter || n.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: n, point: { x: g, y: t }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: x });
                                    t = !1;
                                }
                        d();
                        ba.drawMarkers(l);
                                      ...
                                      d || c
                                          ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                      ...
                                                      ((d = m), (c = u), (m = n.x), (u = n.y), b(), f.moveTo(n.x, n.y), (m = d), (u = c), (G = n), (M = g.nullDataLineDashType), f.setLineDash(T)),
                                                  f.lineTo(m, aa),
                                                  f.lineTo(m, u),
                                                  w && (l.lineTo(m, aa), l.lineTo(m, u)))
                                                : (f.beginPath(), f.moveTo(m, u), w && (l.beginPath(), l.moveTo(m, u)), (G = { x: m, y: u })),
                                            (c = d = !1))
                                          : (f.lineTo(m, aa), w && l.lineTo(m, aa), f.lineTo(m, u), w && l.lineTo(m, u), 0 == r % 250 && b()),
                                      (n = { x: m, y: u }),
                                      r < t.length - 1 &&
                                          (A !== (t[r].lineColor || v) || M !== (t[r].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (A = t[r].lineColor || v),
                                          (f.strokeStyle = A),
                                          f.setLineDash && (t[r].lineDashType ? ((M = t[r].lineDashType), f.setLineDash(J(M, g.lineThickness))) : ((M = g.lineDashType), f.setLineDash(B)))),
                                      (y = g.dataPointIds[r]),
                                      (this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: r, x1: m, y1: u }),
                                      0 !== t[r].markerSize &&
                                          (0 < t[r].markerSize || 0 < g.markerSize) &&
                                          ((aa = g.getMarkerProperties(r, m, u, f)), h.push(aa), (y = P(y)), w && h.push({ x: m, y: u, ctx: l, type: aa.type, size: aa.size, color: y, borderColor: y, borderThickness: aa.borderThickness })),
                                      (t[r].indexLabel || g.indexLabel || t[r].indexLabelFormatter || g.indexLabelFormatter) &&
                                          this._indexLabels.push({ chartType: "stepArea", dataPoint: t[r], dataSeries: g, point: { x: m, y: u }, direction: 0 > t[r].y === a.axisY.reversed ? 1 : -1, color: C }));
                            }
                        b();
                        ba.drawMarkers(h);
                    }
                    ...
                    if (0 < n.length) {
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa))))
                                if ("number" !== typeof ga.y) C.connectNullData || aa || y || d(), (aa = !0);
                                else {
                                    ...
                                    y || aa
                                        ? (!y && C.connectNullData
                                              ? (b.setLineDash &&
                                                    (C.options.nullDataLineDashType || (x === C.lineDashType && C.lineDashType !== C.nullDataLineDashType)) &&
                                                    ((y = k.pop()), (x = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(x), k.push(y), (x = C.nullDataLineDashType), b.setLineDash(T)),
                                                b.lineTo(g, t),
                                                w && m.lineTo(g, t))
                                              : (b.beginPath(), b.moveTo(g, t), w && (m.beginPath(), m.moveTo(g, t))),
                                          (aa = y = !1))
                                        : (b.lineTo(g, t), w && m.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), w && m.moveTo(g, t), k.push({ x: g, y: r - na })));
                                    u = { x: g, y: t };
                                    q < v.length - 1 &&
                                        (M !== (v[q].lineColor || A) || x !== (v[q].lineDashType || C.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, t),
                                        k.push({ x: g, y: r - na }),
                                        (M = v[q].lineColor || A),
                                        (b.strokeStyle = M),
                                        b.setLineDash && (v[q].lineDashType ? ((x = v[q].lineDashType), b.setLineDash(J(x, C.lineThickness))) : ((x = C.lineDashType), b.setLineDash(B))));
                                    if (0 <= C.dataPointIndexes[f]) {
                                        var E = C.dataPointIds[C.dataPointIndexes[f]];
                                        this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: G, dataPointIndex: C.dataPointIndexes[f], x1: g, y1: t };
                                    }
                                    0 <= C.dataPointIndexes[f] &&
                                        0 !== ga.markerSize &&
                                        (0 < ga.markerSize || 0 < C.markerSize) &&
                                        ((na = C.getMarkerProperties(C.dataPointIndexes[f], g, t, b)),
                                        l.push(na),
                                        (f = P(E)),
                                        w && l.push({ x: g, y: t, ctx: m, type: na.type, size: na.size, color: f, borderColor: f, borderThickness: na.borderThickness }));
                                    (ga.indexLabel || C.indexLabel || ga.indexLabelFormatter || C.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: ga, dataSeries: C, point: { x: g, y: t }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, t);
                    ...
                    if (0 < n.length) {
                        ...
                        for (var aa = !0, q = 0; q < n.length; q++) {
                            var f = n[q],
                                ...
                                ga = 0 <= C.dataPointIndexes[f] ? v[C.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa))))
                                if ("number" !== typeof ga.y) C.connectNullData || aa || m || d(), (aa = !0);
                                else {
                                    var na;
                                    ...
                                    m || aa
                                        ? (!m && C.connectNullData
                                              ? (b.setLineDash &&
                                                    (C.options.nullDataLineDashType || (u === C.lineDashType && C.lineDashType !== C.nullDataLineDashType)) &&
                                                    ((m = k.pop()), (u = k[k.length - 1]), d(), b.moveTo(r.x, r.y), k.push(u), k.push(m), (u = C.nullDataLineDashType), b.setLineDash(T)),
                                                b.lineTo(g, t),
                                                w && x.lineTo(g, t))
                                              : (b.beginPath(), b.moveTo(g, t), w && (x.beginPath(), x.moveTo(g, t))),
                                          (aa = m = !1))
                                        : (b.lineTo(g, t), w && x.lineTo(g, t), 0 == q % 250 && (d(), b.moveTo(g, t), w && x.moveTo(g, t), k.push({ x: g, y: y - E })));
                                    r = { x: g, y: t };
                                    q < v.length - 1 &&
                                        (M !== (v[q].lineColor || A) || u !== (v[q].lineDashType || C.lineDashType)) &&
                                        (d(),
                                        b.beginPath(),
                                        b.moveTo(g, t),
                                        k.push({ x: g, y: y - E }),
                                        (M = v[q].lineColor || A),
                                        (b.strokeStyle = M),
                                        b.setLineDash && (v[q].lineDashType ? ((u = v[q].lineDashType), b.setLineDash(J(u, C.lineThickness))) : ((u = C.lineDashType), b.setLineDash(B))));
                                    if (0 <= C.dataPointIndexes[f]) {
                                        var F = C.dataPointIds[C.dataPointIndexes[f]];
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: G, dataPointIndex: C.dataPointIndexes[f], x1: g, y1: t };
                                    }
                                    0 <= C.dataPointIndexes[f] &&
                                        0 !== ga.markerSize &&
                                        (0 < ga.markerSize || 0 < C.markerSize) &&
                                        ((E = C.getMarkerProperties(q, g, t, b)), s.push(E), (f = P(F)), w && s.push({ x: g, y: t, ctx: x, type: E.type, size: E.size, color: f, borderColor: f, borderThickness: E.borderThickness }));
                                    (ga.indexLabel || C.indexLabel || ga.indexLabelFormatter || C.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea100", dataPoint: ga, dataSeries: C, point: { x: g, y: t }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, t);
                        ...
                        for (var p = 0, q = 0, e = 0; e < n.length; e++)
                            if (((f = n[e].getTime ? (f = n[e].x.getTime()) : (f = n[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y)) {
                                ...
                                (Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ...
                                    (p = P(p)),
                                    w && ba.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness),
                        ...
                        for (var x = 5 < t && u.bevelEnabled ? !0 : !1, s = 0; s < y.length; s++)
                            if (
                                ...
                                var z = (h - t / 2) << 0,
                                    ...
                                    v = 0 === C % 2 ? 0 : 0.5,
                                    A = u.dataPointIds[s];
                                this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: fa, dataPointIndex: s, x1: z, y1: k, x2: G, y2: n, x3: h, y3: p, x4: h, y4: q, borderThickness: C, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = C;
                                ...
                                "candlestick" === u.type
                                    ? (c.moveTo(h - v, n),
                                      ...
                                      c.lineTo(h - v, p),
                                      c.stroke(),
                                      ea(c, z, Math.min(k, q), G, Math.max(k, q), y[s].y[0] <= y[s].y[3] ? u.risingColor : f, C, e, x, x, !1, !1, u.fillOpacity),
                                      w &&
                                          ((e = P(A)),
                                          (b.strokeStyle = e),
                                          b.moveTo(h - v, n),
                                          ...
                                          b.lineTo(h - v, p),
                                          b.stroke(),
                                          ea(b, z, Math.min(k, q), G, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === u.type &&
                                      (c.moveTo(h - v, n),
                                      c.lineTo(h - v, p),
                                      c.stroke(),
                                ...
                                (y[s].indexLabel || u.indexLabel || y[s].indexLabelFormatter || u.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 1,
                                        bounds: { x1: z, y1: Math.min(n, p), x2: G, y2: Math.max(n, p) },
                                        color: e,
                                    });
                            }
                }
                        ...
                        for (var z = 5 < t && y.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++)
                            if (
                                ...
                                var G = (s - t / 2) << 0,
                                    ...
                                    S = y.upperBoxColor,
                                    U = y.lowerBoxColor,
                                    ra = r(y.options.fillOpacity) ? 1 : y.fillOpacity,
                                    Q = y.dataPointIds[l];
                                ...
                                c.save();
                                0 < E &&
                                    (c.beginPath(), (c.strokeStyle = na), (c.lineWidth = E), c.setLineDash && c.setLineDash(J(I, E)), c.moveTo(s - F, k), c.lineTo(s - F, h), c.stroke(), c.moveTo(s - F, p), c.lineTo(s - F, n), c.stroke());
                                c.restore();
                                ...
                                w &&
                                    ...
                                    (b.strokeStyle = e),
                                    (b.lineWidth = E),
                                    0 < E && (b.moveTo(s - A - F, k), b.lineTo(s - A - F, Math.max(h, p)), b.stroke(), b.moveTo(s - A - F, Math.min(h, p)), b.lineTo(s - A - F, n), b.stroke()),
                                    ea(b, G, Math.max(k, n), C, Math.min(k, n), e, 0, null, !1, !1, !1, !1),
                                    0 < T && (b.beginPath(), (b.lineWidth = T), b.moveTo(s + aa / 2, p - ga), b.lineTo(s - aa / 2, p - ga), b.stroke(), b.moveTo(s + aa / 2, h + ga), b.lineTo(s - aa / 2, h + ga), b.stroke()));
                                (x[l].indexLabel || y.indexLabel || x[l].indexLabelFormatter || y.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 1,
                                        bounds: { x1: G, y1: Math.min(h, p), x2: C, y2: Math.max(h, p) },
                                        color: e,
                                    });
                            }
                }
                    ...
                    if (0 < g.length)
                        for (var t = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (
                                ...
                                u = q.dataPointIds[f];
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: p, dataPointIndex: f, x1: m, y1: l, x2: fa, y2: s };
        ...
        m.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var fa = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/gi) || !this.data[u].visible || (this.data[u].type.match(/(stacked)/gi) && fa) || fa++;
                for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
                    var x = a.dataSeriesIndexes[y],
                        z = this.data[x],
                        v = z.dataPoints,
                        C = r(z._linkedSeries) ? !1 : z._linkedSeries.type.match(/(bar|column)/gi) && z._linkedSeries.visible ? !0 : !1,
                        A = 0;
                    if (C)
                    ...
                    f &&
                        (s = this.options.dataPointMaxWidth
                            ...
                            ? this.dataPointWidth
                            : b
                            ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (C ? fa : 1))) << 0
                            : 0.03 * this.width);
                    ...
                    if (0 < v.length)
                        for (var B = z._colorSet, s = 0; s < v.length; s++) {
                            ...
                            if (!(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax) && !r(v[s].y) && v[s].y.length && "number" === typeof v[s].y[0] && "number" === typeof v[s].y[1]) {
                                ...
                                b ? (p = ka) : (g = ka);
                                b
                                    ? ((q = a.axisX.reversed ? (k + ((C ? fa : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0 : (k - ((C ? fa : 1) * u) / 2 + (C ? A - 1 : 0) * u) << 0), (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                                    : ((n = a.axisX.reversed ? (h + ((C ? fa : 1) * u) / 2 - (C ? A - 1 : 0) * u) << 0 : (h - ((C ? fa : 1) * u) / 2 + (C ? A - 1 : 0) * u) << 0), (p = a.axisX.reversed ? (n - u) << 0 : (n + u) << 0));
                                !b && q > g && ((ka = q), (q = g), (g = ka));
                                b && n > p && ((ka = n), (n = p), (p = ka));
                                ka = z.dataPointIds[s];
                                ...
                                if (v[s].indexLabel || z.indexLabel || v[s].indexLabelFormatter || z.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: z,
                                        indexKeyword: 0,
                                        point: { x: b ? (v[s].y[1] >= v[s].y[0] ? n : p) : n + (p - n) / 2, y: b ? q + (g - q) / 2 : v[s].y[1] >= v[s].y[0] ? g : q },
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: z,
                                            indexKeyword: 1,
                                            point: { x: b ? (v[s].y[1] >= v[s].y[0] ? p : n) : n + (p - n) / 2, y: b ? q + (g - q) / 2 : v[s].y[1] >= v[s].y[0] ? q : g },
                                            direction: v[s].y[1] >= v[s].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(n, p) : n, y1: b ? q : Math.min(q, g), x2: b ? Math.max(n, p) : p, y2: b ? g : Math.max(q, g) },
                                            color: e,
                                            axisSwapped: b,
                    ...
                    if (0 < t.length) {
                        ...
                        for (f = 0; f < t.length; f++)
                            if (
                                ...
                                b = g.dataPointIds[f];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: f, x1: l, y1: h, x2: s, y2: v };
                                b = P(b);
                ...
                for (var s = 0; s < a.dataSeriesIndexes.length; s++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var M = !0; g < p.length; g++)
                            if (((u = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !M)))))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || M
                                        ? (n.connectNullData && !q
                                              ? (b.setLineDash &&
                                                    (n.options.nullDataLineDashType || (C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType)) &&
                                                    ((h[h.length - 1].newLineDashArray = B), (C = n.nullDataLineDashType), b.setLineDash(A)),
                                                b.lineTo(t, r),
                                                w && e.lineTo(t, r),
                                                h.push({ x: t, y1: r, y2: m }))
                                              : (b.beginPath(), b.moveTo(t, r), (y = { x: t, y: r }), (h = []), h.push({ x: t, y1: r, y2: m }), w && (e.beginPath(), e.moveTo(t, r))),
                                          (M = q = !1))
                                        : (b.lineTo(t, r), h.push({ x: t, y1: r, y2: m }), w && e.lineTo(t, r), 0 == g % 250 && d());
                                    u = n.dataPointIds[g];
                                    this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: t, y1: r, y2: m };
                                    g < p.length - 1 &&
                                        (v !== (p[g].lineColor || z) || C !== (p[g].lineDashType || n.lineDashType)) &&
                                        (d(),
                                        (v = p[g].lineColor || z),
                                        ...
                                        b.setLineDash &&
                                            (p[g].lineDashType
                                                ? ((C = p[g].lineDashType), (h[h.length - 1].newLineDashArray = J(C, n.lineThickness)), b.setLineDash(h[h.length - 1].newLineDashArray))
                                                : ((C = n.lineDashType), (h[h.length - 1].newLineDashArray = B), b.setLineDash(B))));
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize || 0 < n.markerSize)) {
                                        var T = n.getMarkerProperties(g, t, m, b);
                                        f.push(T);
                                        var E = P(u);
                                        w && f.push({ x: t, y: m, ctx: e, type: T.type, size: T.size, color: E, borderColor: E, borderThickness: T.borderThickness });
                                        T = n.getMarkerProperties(g, t, r, b);
                                        f.push(T);
                                        E = P(u);
                                        w && f.push({ x: t, y: r, ctx: e, type: T.type, size: T.size, color: E, borderColor: E, borderThickness: T.borderThickness });
                                    }
                                    if (p[g].indexLabel || n.indexLabel || p[g].indexLabelFormatter || n.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: n, indexKeyword: 0, point: { x: t, y: r }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: x }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: p[g],
                                                dataSeries: n,
                        ...
                        for (g = !1; p < n.length; p++)
                            if (((q = n[p].x.getTime ? n[p].x.getTime() : n[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: p, x1: q, y1: g, y2: t };
                                    r[r.length] = { x: q, y: g };
                                    m[m.length] = { x: q, y: t };
                                    p < n.length - 1 &&
                                        (x !== (n[p].lineColor || y) || z !== (n[p].lineDashType || k.lineDashType)) &&
                                        ((x = n[p].lineColor || y),
                                        (r[r.length - 1].newStrokeStyle = x),
                                        b.setLineDash && (n[p].lineDashType ? ((z = n[p].lineDashType), (r[r.length - 1].newLineDashArray = J(z, k.lineThickness))) : ((z = k.lineDashType), (r[r.length - 1].newLineDashArray = A))));
                                    if (0 !== n[p].markerSize && (0 < n[p].markerSize || 0 < k.markerSize)) {
                                        var I = k.getMarkerProperties(p, q, g, b);
                                        f.push(I);
                                        var M = P(E);
                                        w && f.push({ x: q, y: g, ctx: e, type: I.type, size: I.size, color: M, borderColor: M, borderThickness: I.borderThickness });
                                        I = k.getMarkerProperties(p, q, t, b);
                                        f.push(I);
                                        M = P(E);
                                        w && f.push({ x: q, y: t, ctx: e, type: I.type, size: I.size, color: M, borderColor: M, borderThickness: I.borderThickness });
                                    }
                                    if (n[p].indexLabel || k.indexLabel || n[p].indexLabelFormatter || k.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: n[p].y[0] <= n[p].y[1] ? -1 : 1, color: u }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: n[p], dataSeries: k, indexKeyword: 1, point: { x: q, y: t }, direction: n[p].y[0] <= n[p].y[1] ? 1 : -1, color: u });
                                    g = !1;
                                } else
                                    0 < p &&
                                        !g &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < r.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType) && ((r[r.length - 1].newLineDashArray = C), (z = k.nullDataLineDashType))
                                            : (d(A, y), (r = []), (m = []))),
                                        (g = !0);
                        d(A, y);
                        ba.drawMarkers(f);
                    ...
                    if (0 < m.length)
                        for (var x = 5 < q && r.bevelEnabled ? !0 : !1, v = !1, A = null, C = null, l = 0; l < m.length; l++)
                            if ((m[l].getTime ? (n = m[l].x.getTime()) : (n = m[l].x), "number" !== typeof m[l].y)) {
                                ...
                                e = r.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: t, dataPointIndex: l, x1: s, y1: h, x2: B, y2: k };
                                ...
                                var T,
                                    M = s;
                                T =
                                    ("undefined" !== typeof m[l].isIntermediateSum && !0 === m[l].isIntermediateSum) || ("undefined" !== typeof m[l].isCumulativeSum && !0 === m[l].isCumulativeSum)
                                        ? 0 < m[l].y
                                            ? h
                                            : k
                                        : 0 < m[l].y
                                ...
                                0 < l &&
                                    ...
                                    c.lineTo(M, T - y),
                                    0 < u && c.stroke(),
                                    w && (b.beginPath(), b.moveTo(A, C - y), b.lineTo(M, T - y), 0 < u && b.stroke()));
                                v = !1;
                                A = B;
                                C = 0 < m[l].y ? h : k;
                                ...
                                (m[l].indexLabel || r.indexLabel || m[l].indexLabelFormatter || r.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "waterfall",
                                        dataPoint: m[l],
                                        dataSeries: r,
        ...
        var ia = function (a, d, c, b, e, f, l, h, r) {
            if (!(0 > c)) {
                ...
                "pie" === e
                    ...
                    : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= r && a.arc(d.x, d.y, r * c, l, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
                a.globalAlpha = 1;
                a.restore();
            }
        };
        m.prototype.renderPie = function (a) {
            function d() {
                if (k && n) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
                        ...
                        if (k.indexLabelFormatter || f.indexLabelFormatter) s = { chart: m.options, dataSeries: k, dataPoint: f, total: p.total, percent: p.percent };
                        ...
                        for (var s, r, a = 0; a < n.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                var z = 0,
                                    z = b(s, r) - t;
                                if (0 > z) {
                                    for (var A = (r = 0), G = 0; G < n.length; G++) G !== a && g[G].hemisphere === h.hemisphere && (g[G].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ : A++);
                                    r = (z / (r + A || 1)) * A;
                                    var A = -1 * (z - r),
                                        J = (G = 0);
                                    "right" === h.hemisphere
                                        ? ((G = f(a, r)), (A = -1 * (z - G)), (J = f(u, A)), +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(a, -(A - J)))
                                        : ((G = f(u, r)), (A = -1 * (z - G)), (J = f(a, A)), +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(u, -(A - J)));
                                }
                            }
                        }
                    } else
                        ...
                        if (((h = g[a]), (u = h.indexLabelTextBlock.measureText()), 0 !== u.height && 0 !== u.width))
                            (u = u = 0),
                                ...
                                0 < u &&
                                    ...
                                    Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - x.y) < C || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - x.y) < C) &&
                                ...
                                0 < u &&
                                    ...
                                    Math.abs(h.indexLabelTextBlock.x - x.x) < C && ((u /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < u && (u *= 0.3), u > d && (d = u)));
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < n.length; A++)
                    (z += Math.abs(n[A].y)),
                        !a && "undefined" !== typeof n[A].indexLabel && null !== n[A].indexLabel && 0 < n[A].indexLabel.toString().length && (a = !0),
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function b() {
                if (u && y) {
                    for (var a, b, c, d, e, f, k, l, h, n, p, q, s, m, t, D = [], x = [], v = { percent: null, total: null }, z = null, C = 0; C < y.length; C++)
                    ...
                    for (var C = 0, B = y.length - 1; C < y.length || 0 <= B; C++, B--) {
                        ...
                        s = u.dataPointIds[C];
                        A._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataPointIndex: C, dataSeriesIndex: 0, funnelSection: Q[u.reversed ? y.length - 1 - C : C] };
                        "inside" === u.indexLabelPlacement &&
                            ((D[C] = C !== ca ? (u.reversed ? Q[C].x2 - Q[C].x1 : Q[C].x3 - Q[C].x4) : Q[C].x3 - Q[C].x6),
                            20 > D[C] && ((D[C] = C !== ca ? (u.reversed ? Q[C].x3 - Q[C].x4 : Q[C].x2 - Q[C].x1) : Q[C].x2 - Q[C].x1), (D[C] /= 2)));
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--)
                        (a = Q[l]),
                            ...
                            u.reversed
                                ? (H[l].textBlock.y + H[l].height > oa + z && (H[l].textBlock.y = oa + z - H[l].height), H[l].textBlock.y < ra - z && (H[l].textBlock.y = ra - z))
                    ...
                    for (var e = 0; e < Q.length; e++)
                        0 == H[e].textBlock.text.length
                            ...
                            : ((a = Q[e]),
                              ...
                              u.reversed
                                  ? (H[e].textBlock.y + H[e].height > oa + z && (H[e].textBlock.y = oa + z - H[e].height), H[e].textBlock.y < ra - z && (H[e].textBlock.y = ra - z))
                                  : (H[e].textBlock.y < oa - z && (H[e].textBlock.y = oa - z), H[e].textBlock.y + H[e].height > ra + z && (H[e].textBlock.y = ra + z - H[e].height)));
                else
            ...
            function l() {
                    ...
                    for (var k, h = 1; h < l; h++) {
                        ...
                        for (var s = H.length - 1; 0 <= s; s--)
                            !H[s].isDirty &&
                                ...
                                ((k = q(s)), !(k >= H.length - 1) && H[s].textBlock.y + H[s].height + da > H[k].textBlock.y && (H[s].textBlock.y = H[s].textBlock.y + H[s].height - e > e - H[s].textBlock.y ? e + 1 : e - H[s].height - 1));
                    }
                ...
                for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
                    for (
                        ...
                        (e = +g.y.toFixed(6)),
                        !f.isDirty && l && e + d + da > +k.y.toFixed(6) && ((d = g.y + d + da - k.y), (e = a(m, -d)), e < d && (0 < e && (d -= e), (e = a(q(m), d)), e != d)));
                        m--
                    );
                    b();
                }
            ...
            function n(a) {
                for (var b, c, d, e, f = 0; f < Q.length; f++)
                    (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
                        ...
                        H[f].isDirty ||
                            0 == H[f].lineThickness ||
                            ((a.strokeStyle = H[f].lineColor), (a.lineWidth = H[f].lineThickness), a.setLineDash && a.setLineDash(J(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke());
            }
            function p(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (
                    var u = this.data[a.dataSeriesIndexes[0]], y = u.dataPoints, x = this.plotArea, z = 0.025 * x.width, B = 0.01 * x.width, C = 0, E = x.height - 2 * z, I = Math.min(x.width - 2 * B, 2.8 * x.height), M = !1, T = 0;
                    T < y.length;
                    T++
                )
                    if (
                        (!M && "undefined" !== typeof y[T].indexLabel && null !== y[T].indexLabel && 0 < y[T].indexLabel.toString().length && (M = !0),
                        !M && "undefined" !== typeof y[T].label && null !== y[T].label && 0 < y[T].label.toString().length && (M = !0),
                        (!M && "function" === typeof u.indexLabelFormatter) || "function" === typeof y[T].indexLabelFormatter)
                    )
                        M = !0;
                ...
                if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
                    ...
                    "funnel" === u.type
                        ? ((P = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
                          ...
                          "string" === typeof P && P.match(/%$/) ? ((P = parseInt(P)), (P = (P * E) / 100)) : (P = parseInt(P)),
                          "string" === typeof F && F.match(/%$/) ? ((F = parseInt(F)), (F = (F * a) / 100)) : (F = parseInt(F)),
                          P > E ? (P = E) : 0 >= P && (P = 0),
                          F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
                        : "pyramid" === u.type && ((F = P = 0), (u.reversed = u.reversed ? !1 : !0));
                    var B = T + a / 2,
                        Z = T,
                        X = T + a,
                        oa = u.reversed ? R : O,
                    ...
                    if (-1 !== T) {
                        if (u.reversed) for (I.push(V), F = T.length - 1; 0 < F; F--) (V += T[F]), I.push(V);
                        else for (F = 0; F < T.length; F++) (V += T[F]), I.push(V);
                        if (u.reversed) for (F = 0; F < T.length; F++) I[F] < Ba ? (a.push(L), B.push(ba), (ca = F)) : (a.push((I[F] - oa + $ * Z) / $), B.push((I[F] - oa + ea * X) / ea));
                        else for (F = 0; F < T.length; F++) I[F] < Ba ? (a.push((I[F] - oa + $ * Z) / $), B.push((I[F] - oa + ea * X) / ea), (ca = F)) : (a.push(L), B.push(ba));
                        for (F = 0; F < T.length - 1; F++)
                            (V = u.reversed ? (y[y.length - 1 - F].color ? y[y.length - 1 - F].color : u._colorSet[(y.length - 1 - F) % u._colorSet.length]) : y[F].color ? y[F].color : u._colorSet[F % u._colorSet.length]),
                                F === ca
                                    ? Q.push({ x1: a[F], y1: I[F], x2: B[F], y2: I[F], x3: ba, y3: Ba, x4: B[F + 1], y4: I[F + 1], x5: a[F + 1], y5: I[F + 1], x6: L, y6: Ba, id: F, height: I[F + 1] - I[F], color: V })
                                    : Q.push({ x1: a[F], y1: I[F], x2: B[F], y2: I[F], x3: B[F + 1], y3: I[F + 1], x4: a[F + 1], y4: I[F + 1], id: F, height: I[F + 1] - I[F], color: V });
                        var da = 2,
                            H = [],
                            ha = !1,
                            Y = [],
                        ...
                        a = a = 0;
                        Da(Y);
                        for (F = 0; F < y.length; F++) y[F].exploded && ((T = !0), u.reversed ? Y.push(y.length - 1 - F) : Y.push(F));
                        ...
                        for (F = 0; F < Q.length; F++) (C = Q[F]), qa(S, C, u.fillOpacity), ia.push(C.y1);
                        v(S);
                    ...
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        ...
                        for (var y = 0; y < p.dataPoints.length; y++) {
                            var x = p.dataPoints[y],
                                ...
                                q = { markerType: q, markerColor: t, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: n, dataPointIndex: y, markerBorderColor: v, markerBorderThickness: u };
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "bubble":
                                w = q.size;
                                m = Math.sqrt(Math.pow(q.x1 - a, 2) + Math.pow(q.y1 - d, 2));
                                m <= w / 2 && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: m }), (h = !0));
                                break;
                            case "pie":
                            case "doughnut":
                                w = q.center;
                                ...
                                m < q.radius &&
                                    ...
                                    m > w && m < v && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (h = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                m = q.funnelSection;
                                d > m.y1 &&
                                    ...
                                    (m.y6
                                        ? d > m.y6
                                            ? ((f = m.x6 + ((m.x5 - m.x6) / (m.y5 - m.y6)) * (d - m.y6)), (m = m.x3 + ((m.x4 - m.x3) / (m.y4 - m.y3)) * (d - m.y3)))
                                            : ((f = m.x1 + ((m.x6 - m.x1) / (m.y6 - m.y1)) * (d - m.y1)), (m = m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (d - m.y2)))
                                        : ((f = m.x1 + ((m.x4 - m.x1) / (m.y4 - m.y1)) * (d - m.y1)), (m = m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (d - m.y2))),
                                    a > f && a < m && (b.push({ dataPoint: g, dataPointIndex: q.dataPointIndex, dataSeries: this, distance: 0 }), (h = !0)));
                                break;
                            case "boxAndWhisker":
                                if (
                ...
                (h =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ? (this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
                          Math.log(this.range)
                        : (this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * I[this.intervalType + "Duration"] * this.interval),
                ...
                (h =
                    this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length
                        ? (this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position))) /
                          Math.log(this.range)
                        : (this.lineCoordinates.height / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range))) * I[this.intervalType + "Duration"] * this.interval),
                                    ...
                                    if (
                                        ...
                                        this.labelWrap
                                            ...
                                            ? ((this.sessionVariables.labelWrap = this.labelWrap),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelMaxWidth = f),
                                              d && (t.width + d.width) >> 0 > 2 * f && ((this.sessionVariables.labelAngle = -25), (this.sessionVariables.labelMaxWidth = n)))
                                            : ((this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle),
                                              (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth),
                                              (this.sessionVariables.labelMaxHeight = l),
                                              (this.sessionVariables.labelWrap = this.labelWrap));
            ...
            if ("normal" === e) {
                for (var y = [], x = [], z = [], A = [], N = [], O = [], P = [], R = []; 4 > w; ) {
                    var F = 0,
                        ...
                        Q = 0,
                        $ = 0;
                    if (c && 0 < c.length) for (z = [], g = Q = 0; g < c.length; g++) z.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (Q += z[g]), (L += c[g] && !n.isNavigator ? c[g].margin : 0);
                    else z.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                    P.push(z);
                    if (b && 0 < b.length) for (A = [], g = $ = 0; g < b.length; g++) A.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), ($ += A[g]), (Z += b[g] ? b[g].margin : 0);
                        ...
                        for (g = 0; g < a.length; g++)
                            a[g] &&
                                ...
                                !a[g] ||
                                    ...
                                    ((h = 0),
                                    0 < a[g].labelAngle
                                        ? B + u > m && (h += 0 < a[g].labelAngle ? B + u - m - $ : 0)
                                        : 0 > a[g].labelAngle
                                        ? C - v < l && C - v < a[g].viewportMinimum && (E = l - (L + a[g].tickLength + z + C - v + a[g].labelFontSize / 2))
                                        : 0 === a[g].labelAngle && (B + u > m && (h = B + u / 2 - m - $), C - v < l && C - v < a[g].viewportMinimum && (E = l - L - a[g].tickLength - z - C + v / 2)),
                                ...
                                n.panEnabled ? (V = r(n.sessionVariables.axisX.height) ? (n.sessionVariables.axisX.height = V) : n.sessionVariables.axisX.height) : (n.sessionVariables.axisX.height = V),
                                ...
                                (a[g].bounds = { x1: l, y1: h, x2: m, y2: k - (V + e - y[g] - F), width: m - l, height: k - h })),
                                (F += y[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + Q + L)),
                                ...
                                d[g]._labels &&
                                    ...
                                    (v = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                                    (u = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                                n.panEnabled ? (X = r(n.sessionVariables.axisX2.height) ? (n.sessionVariables.axisX2.height = X) : n.sessionVariables.axisX2.height) : (n.sessionVariables.axisX2.height = X),
                                (h = Math.round(f.y1)),
                                ...
                                (d[g].bounds = { x1: l, y1: h + (X + Y - x[g] - S), x2: m, y2: k, width: m - l, height: k - h }),
                                (S += x[g] + d[g].margin);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (L = n.isNavigator ? 0 : 10),
                                c[g] &&
                                    ...
                                    (h = Math.round(f.y1 + X + Y < Math.max(L, p) ? Math.max(L, p) : f.y1 + X + Y)),
                                    ...
                                    (c[g].lineCoordinates = { x1: l - U, y1: h, x2: m - U, y2: k, height: Math.abs(k - h) }),
                                    "inside" === c[g].labelPlacement &&
                                        0 < g &&
                                        ((c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (z[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                                        (c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2)),
                                    (c[g].bounds = { x1: l - (z[g] + U), y1: h, x2: m, y2: k, width: m - l, height: k - h }),
                        ...
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                "inside" === b[g].labelPlacement &&
                                    0 < g &&
                                    ((b[g].lineCoordinates.x1 = b[g].lineCoordinates.x1 + (A[g] - (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)) - ("outside" === b[g].tickPlacement ? b[g].tickLength : 0) - 2),
                                    (b[g].lineCoordinates.x2 = b[g].lineCoordinates.x1 + b[g].lineThickness / 2)),
                                (b[g].bounds = { x1: l, y1: h, x2: m + (A[g] + W), y2: k, width: m - l, height: k - h }),
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) t = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else t = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = O[w - 1][g] === O[w][g] ? !0 : !1;
                        else I = !0;
                ...
                for (O = []; 4 > w; ) {
                    ...
                    if (a && 0 < a.length) for (E = [], g = W = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (W += E[g]), (e += a[g] && !n.isNavigator ? a[g].margin : 0);
                    else E.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    N.push(E);
                    if (d && 0 < d.length) for (v = [], g = V = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (V += v[g]), (Y += d[g] ? d[g].margin : 0);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (c[g].lineCoordinates = {}),
                                ...
                                (m = Math.round(f.x2 - V - Y > n.width - 10 ? n.width - 10 : f.x2 - V - Y)),
                                c[g].labelAutoFit &&
                                    !r(y) &&
                                    (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, y) : 0 === c[g].labelAngle ? Math.max(l, y / 2) : l),
                                    0 < !d.length && (m = 0 < c[g].labelAngle ? m - x / 2 : 0 === c[g].labelAngle ? m - x / 2 : m)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                (l = Math.round(f.x1 + W + e)),
                                (m = Math.round(f.x2 - V - Y > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - V - Y)),
                                b[g] && b[g].labelAutoFit && !r(z) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, z) : 0 === b[g].labelAngle ? Math.max(l, z / 2) : l), 0 < !d.length && (m -= A / 2)),
                    ...
                    B.push(p);
                    if (b && 0 < b.length) for (C = [], g = S = 0; g < b.length; g++) C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (S += C[g]), (Z += b[g].margin);
                    ...
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            (h = Math.round(f.y2)),
                                ...
                                (c[g].bounds = { x1: l, y1: h - (p[g] + X + c[g].margin), x2: m, y2: k - (X + c[g].margin), width: m - l, height: p[g] }),
                                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                                (X += p[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] &&
                                ...
                                (b[g].bounds = { x1: l, y1: h + (b[g].margin + F), x2: m, y2: k, width: m - l, height: S }),
                                b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                                (F += C[g] + b[g].margin));
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k =
                                c && 0 < c.length
                                    ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > n.height - Math.max(L, 10) ? n.height - Math.max(L, 10) : f.y2 - U)
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((m = b[L].lineCoordinates.x2), (l = m - V));
                            ...
                            d[g].bounds = { x1: d[g].lineCoordinates.x1, y1: h, x2: m + v[g] + R, y2: k, width: m - l, height: k - h };
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = B[w - 1][g] === B[w][g] ? !0 : !1;
                        else J = !0;
                ...
                if ("axisX" === this.type && c) {
                    ...
                    this.intervalType ||
                        (b / 1 <= a
                            ...
                            : ((this.interval = b / (1 * I.yearDuration) <= a ? 1 : b / (2 * I.yearDuration) <= a ? 2 : b / (4 * I.yearDuration) <= a ? 4 : Math.floor(A.getNiceNumber(b / (a - 1), !0) / I.yearDuration)),
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[B].dataPoint.y[0])), u = 0, t = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (var y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                            else (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y))), u < v && ((v = u), (B = t));
                    else if ("stackedBar" === n[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), x = (u = 0), t = (B = 0); t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = (x = u = 0), t = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                            else
                                (x += n[t].dataPoint.y),
                                    (z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x),
                                    (z = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[z])),
                                    (u = Math.abs(a - this.parent.convertValueToPixel(z))),
                                    u < v && ((v = u), (B = t));
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = B = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                            else (u = Math.abs(a - this.parent.convertValueToPixel(n[t].dataPoint.y))), u < v && ((v = u), (B = t));
                    y = n[B];
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[B].type || "error" === this.parent.dataSeries[B].type) {
                            ...
                            k.text = this.labelFormatter
                                ...
                                ? da(r(c) ? y.dataPoint.y[b] : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            k.text = this.labelFormatter
                                ...
                                : r(this.options.label)
                                ? da(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                            ...
                            this.value = z;
                            k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: z })
                                : r(this.options.label)
                                ? da(r(c) ? z : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label;
                        } else
                            (m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                        ...
                        if (z) {
                            if ("axisX" === this.parent.type)
                                for (t = this.parent.convertPixelToValue({ y: d }), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                            ...
                            "dateTime" === this.parent.valueType
                                ? (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x })
                                      : r(this.options.label)
                                      ? Aa(y.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label)
                    ...
                    if (z) {
                        if ("axisX" === this.parent.type)
                            for (t = this.parent.convertPixelToValue({ x: a }), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                                (v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) &&
                                    0 <= v.index &&
                                    (k.text = this.labelFormatter
                                        ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: y.dataPoint.x })
                    ...
                    if (
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), t = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = x = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = z = x = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                            else
                                (x += n[t].dataPoint.y),
                                    (z = n[t].dataPoint.x.getTime ? n[t].dataPoint.x.getTime() : n[t].dataPoint.x),
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), t = u = 0; t < n.length; t++)
                            if (n[t].dataPoint.y && n[t].dataPoint.y.length) for (y = 0; y < n[t].dataPoint.y.length; y++) (u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y[y]))), u < v && ((v = u), (B = t));
                            else (u = Math.abs(d - this.parent.convertValueToPixel(n[t].dataPoint.y))), u < v && ((v = u), (B = t));
                    y = n[B];
                    b = 0;
                        ...
                        "waterfall" === this.parent.dataSeries[B].type
                            ? ((w =
                              ...
                              (k.text = this.labelFormatter
                                  ...
                                  : r(this.options.label)
                                  ? da(r(c) ? y.dataSeries.dataPointEOs[y.index].cumulativeSum : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = y.dataSeries.dataPointEOs[y.index].cumulativeSum))
                            : ((w = 1 === q.lineWidth % 2 ? (r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0) + 0.5 : r(a) ? d : this.parent.convertValueToPixel(y.dataPoint.y) << 0),
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? y.dataPoint.y : c })
                                  : r(this.options.label)
                                  ? da(r(c) ? y.dataPoint.y : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label),
                              (this.value = y.dataPoint.y));
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (z) {
                            if ("axisX" === this.parent.type)
                                for (t = this.parent.convertPixelToValue({ y: d }), v = null, B = 0; B < this.parent.dataSeries.length; B++)
                                    (v = this.parent.dataSeries[B].getDataPointAtX(t, !0)) &&
                                        0 <= v.index &&
                                        (k.text = this.labelFormatter
                                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c })
                                            : r(this.options.label)
                                            ? v.dataPoint.label
                                            : this.label);
                        } else
                            "dateTime" === this.parent.valueType
                                ? (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c })
                                      : r(this.options.label)
                                      ? Aa(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label)
                                : "number" === this.parent.valueType &&
                                  (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(d) : c })
                                      : r(this.options.label)
                                      ? da(r(c) ? this.parent.convertPixelToValue(d) : c, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                        ...
                        if ("bottom" === this.parent._position || "top" === this.parent._position)
                            (k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c })
                                : r(this.options.label)
                                ? da(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                                : this.label),
                                (k.x = b - k.measureText().width / 2),
                                k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width),
                                k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1),
                    ...
                    if (z) {
                        ...
                        "dateTime" === this.parent.valueType
                            ? (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? this.parent.convertPixelToValue(a) : c })
                                  : r(this.options.label)
                                  ? Aa(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label)
                            : "number" === this.parent.valueType &&
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: r(c) ? (0 < this.parent.dataSeries.length ? this.parent.convertPixelToValue(a) : "") : c })
                                  : r(this.options.label)
                                  ? da(r(c) ? this.parent.convertPixelToValue(a) : c, this.valueFormatString, this.chart._cultureInfo)
                                  : this.label);
                    k.x = b - k.measureText().width / 2;
                        ...
                        "rangeSplineArea" === b.type
                            ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                              ...
                              "undefined" !== typeof e.y2 &&
                                  ...
                                  ba.drawMarkers([f])))
                            : "bubble" === b.type
                            ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), ba.drawMarkers([f]), (d.globalAlpha = 1))
                            : "column" === b.type ||
                            ...
                            ? ia(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
                            ...
                            ? (d.save(),
                              ...
                              d.restore(),
                              (d.globalAlpha = 1))
                            : "error" === b.type && E(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3));
                }
            }
            d.restore();
            d.globalAlpha = 1;
